    ...
    <div className={classes.container}>
      ...
      <div className={classes.wrapper}>
        <div className={classes.left}>
          <img src={`http://localhost:5002/images/${propertyDetail?.img}`} />
        </div>
            ...
            <div className={classes.priceAndOwner}>
              ...
              <span style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                Owner: {propertyDetail?.currentOwner?.profileImg
                  ? (
                    <img src={`http://localhost:5002/images/${propertyDetail?.currentOwner?.profileImg}`} className={classes.owner} />
                  ) : (
      ...
      <div className={classes.commentSection}>
        ...
        {user?._id != null && <div className={classes.commentInput}>
          <img src={`http://localhost:5002/images/${user?.profileImg}`} />
